...
\subsection{Verus}
Verus\cite{verus} is the first deductive Rust verifier that leverages the borrow checker to enable efficient SMT encoding of verification conditions. Its specification and proof language is also based on Rust itself. 
...
Verus implements a comprehensive subset of Rust's language features and has demonstrated scalability in large-scale, complex system architectures\cite{verus_publications}.
