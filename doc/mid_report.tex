...
\begin{lstlisting}[language=Rust,style=colouredRust, caption={The specification of the \texttt{push} method of \texttt{BinaryHeap}.}, label = {3}]
...
\begin{enumerate}
   ...
   \end{itemize}
   \item Add preconditions and postconditions to methods of the target struct. For example, see listing~\ref{3}.  
